...
### Datos para descarga: [Capa de infraestructura verde en el CBIMA](https://raw.githubusercontent.com/atlas-servicios-ecosistemicos-gam/datos/master/infraestructura-verde/cbima/IV_CBI_RIO_MARIA_AGUILAR.TIF)
```{r}
